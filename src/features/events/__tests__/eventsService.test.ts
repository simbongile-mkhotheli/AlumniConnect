...
import { EventsMockApiService } from '../services/mockApi';
import { EVENTS_ENDPOINTS as EVENTS } from '../services/endpoints';
import type {
  Event,
  EventFilters,
  EventFormData,
...
vi.mock('@shared/services', () => ({
  ...
  // Provide shouldUseMockApi so services can branch without import errors.
...
// Mock environment variable (align with code expecting VITE_USE_MOCK_API)
...
describe('EventsService', () => {
  ...
  // Also flip shouldUseMockApi mock return for this test
