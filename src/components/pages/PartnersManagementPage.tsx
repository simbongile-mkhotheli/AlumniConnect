...
const PartnersManagementPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (filters.search) {
      ...
      filtered = filtered.filter(partner => {
        ...
        const desc = (partner.description || '').toLowerCase();
  ...
  // Safely capitalize values like 'pending' -> 'Pending'
            ...
            {filteredPartners.map(partner => (
              ...
              >
                ...
                <div className="partner-image">
                  ...
                  <div className={`partner-type-badge ${partner.type || 'unknown'}`}>
                    {getTypeDisplayName(partner.type)}
                  </div>
                  <div className={`partner-status ${partner.status || 'unknown'}`}>
                ...
                <div className="partner-card-content">
                  ...
                  <div className="partner-tags">
                    {(Array.isArray(partner.tags) ? partner.tags : []).map((tag, index) => (
