...
import type { Sponsor, ApiResponse } from '../../types';
...
export const SponsorsManagementPage: React.FC = () => {
  ...
  // Safely capitalize a string like 'gold' -> 'Gold', fallback to 'Unknown'
                ...
                <div className="sponsor-card-content">
                  <div className="sponsor-card-header">
                    ...
                    <div className="sponsor-subtitle">
                      {(sponsor.tags && sponsor.tags.length > 0 ? sponsor.tags[0] : 'General')} •{' '}
                      {capitalize(sponsor.tier)}{' '}
                      Sponsor
                    </div>
                  </div>
